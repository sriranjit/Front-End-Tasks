// Function to show sum of two numbers
var showSum = function(number1, number2) {
	var total = number1 + number2;
	console.log("The sum is " + total);
  };
  
  // Testing showSum function
  showSum(30, 23);   // Output: The sum is 53
  showSum(2.8, -5);  // Output: The sum is -2.2
  
  // Adding 56 and 74 using showSum function
  showSum(56, 74);   // Output: The sum is 130
  
  // Function to show product of two numbers
  var showProduct = function(number1, number2) {
	var product = number1 * number2;
	console.log("The product is " + product);
  };
  
  // Testing showProduct function
  showProduct(5, 4);   // Output: The product is 20
  showProduct(-3, 7);  // Output: The product is -21
  showProduct(2.5, 3); // Output: The product is 7.5
  
  // Function to show difference of two numbers
  ...
  showDifference(8, 12);   // Output: The difference is -4
  showDifference(-3, -7);  // Output: The difference is 4
  
  // Function to show quotient of two numbers
  ...
  showQuotient(7, 2);    // Output: The quotient is 3.5
